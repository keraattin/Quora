...
namespace Quora
{
    public partial class UserQuestions : System.Web.UI.Page
    {
        ...
        {
            SqlCommand sc = new SqlCommand();
            sc.CommandText = "Select Question.QuestionId,Question.Question From Question,UserAskQuestion,Users " +
            " Where Question.QuestionId = UserAskQuestion.QuestionId AND UserAskQuestion.UserId = Users.UserId " +
            ...
            RepeaterQuestions.DataSource = followingReader;
