<%@ Page Title="" Language="C#" MasterPageFile="~/HomePage.Master" AutoEventWireup="true" CodeBehind="UserQuestions.aspx.cs" Inherits="Quora.UserQuestions" %>
            ...
            <div class="col-md-5">
                ...
                <asp:Repeater ID="RepeaterQuestions" runat="server">
                    <ItemTemplate>
                        ...
                        <b><a href="Question.aspx?QuestionId=<%# Eval("QuestionId") %>"><%# Eval("Question") %></a></b><hr />
                        </div>
                    </ItemTemplate>
                </asp:Repeater>
            </div>
